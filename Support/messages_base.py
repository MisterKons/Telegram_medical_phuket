...
messages = {
    "en": {
        ...
        "feedback_user": "😊 Thank you for planning to send us your feedback. It is very important for us to know how we can improve our service. You can send an email to thesoowai.inc@gmail.com or send a message in the chat.",
    ...
    "rus": {
        ...
        "feedback_user": "😊 Спасибо, что планируете отправить нам ваш комментарий. Нам очень важно узнать, как мы можем улучшить наш сервис. Вы можете отправить письмо по электронной почте на адрес thesoowai.inc@gmail.com или отправить сообщение в чат.",
    ...
    "ger": {
        ...
        "feedback_user": "😊 Vielen Dank, dass Sie uns Ihr Feedback geben möchten. Es ist sehr wichtig für uns zu wissen, wie wir unseren Service verbessern können. Sie können eine E-Mail an thesoowai.inc@gmail.com senden oder eine Nachricht im Chat senden.",
    ...
    "thai": {
        ...
        "feedback_user": "😊 ขอบคุณที่วางแผนจะส่งความคิดเห็นให้เรา มันสำคัญมากที่เราจะทราบวิธีที่เราสามารถปรับปรุงบริการของเรา คุณสามารถส่งอีเมลไปที่ thesoowai.inc@gmail.com หรือส่งข้อความในแชท",
